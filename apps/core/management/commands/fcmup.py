...
class Command(BaseCommand):
    def handle(self, *args, **options):
        with open(os.path.join(settings.BASE_DIR, "requirements/base.txt"), "r+") as fcm_requirement:
        ...
        self.stdout.write(self.style.SUCCESS("FCM is up Check the core directory and follow the instruction in README"))
